      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ "margin-bottom": "1.2rem" }}>
            ...
            <input type="text" value={username()} onInput={(e) => setUsername(e.currentTarget.value)} required style={{
            width: "100%",
            padding: "0.75rem",
            "border-radius": "8px",
            border: `1px solid ${borderColor()}`,
          ...
          <div style={{ "margin-bottom": "1.5rem" }}>
            ...
            <input type="password" value={password()} onInput={(e) => setPassword(e.currentTarget.value)} required style={{
            width: "100%",
            padding: "0.75rem",
            "border-radius": "8px",
            border: `1px solid ${borderColor()}`,
          ...
          <Show when={mode() === "register" && authStatus()?.registrationSecretRequired}>
            <div style={{ "margin-bottom": "1.5rem" }}>
              ...
              <input type="password" value={secret()} onInput={(e) => setSecret(e.currentTarget.value)} required placeholder="Ask the admin for the code" style={{
            width: "100%",
            padding: "0.75rem",
            "border-radius": "8px",
            border: `1px solid ${borderColor()}`,
